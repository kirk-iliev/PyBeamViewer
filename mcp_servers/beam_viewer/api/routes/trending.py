...
from ..schemas.trending import TrendingConfig, TrendingDepthSet, TrendingHistory, TrendingVisibleSet
...
def set_trending_visible(body: TrendingVisibleSet, bridge: HeadlessBridge = Depends(get_bridge)):
